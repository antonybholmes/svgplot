...
def kmf_plot(svg: SVGFigure,
    ...
    if show_axes:
        plot_survival_axes(svg, axes, type)

    return df, kmf


def plot_survival_axes(svg: SVGFigure, axes: tuple[Axis, Axis], type: str = 'OS') -> None:
    xaxis, yaxis = axes
    h = yaxis.w
